...
FragTrap::FragTrap( void ) : _hitPoints( 100 ), _maxHitPoints( 100 ), _energy( 100 ), _maxEnergy( 100 ), _level( 1 ), _name( " name" ), _meleeAtackDamage( 30 ), _rangeAtackDamage( 20 ), _armorDamageReduce( 5 ) {
	return ;
}
...
void		FragTrap::beRepaired( unsigned int amount ) {
	setHitPoint( amount , 1 );
		std::cout << getName() << " be Repaired at " << amount << " Point his Energy is " << getEnergy() << std::endl;
}
