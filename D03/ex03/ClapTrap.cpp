...
ClapTrap::ClapTrap( void ) : _name( "name"), _hitPoints( 100 ), _maxHitPoints( 100 ), _energy( 100 ), _maxEnergy( 100 ), _level( 1 ), _meleeAtackDamage( 30 ), _rangeAtackDamage( 20 ), _armorDamageReduce( 5 ) {
	return ;
}
